...
const BusinessPermit = ({specificUser}) => {
     ...
     const handleDownload = () => {
        ...
        if (specificUser !== null) {
            saveAs(out, specificUser[0]._id + "-Business-Permit.docx");
        } else {
            saveAs(out,"Business-Permit.docx");
        }
    ...
    return ( 
        <Button variant="warning" onClick={handleDownload}>Business-Permit.docx</Button>
     );
}
