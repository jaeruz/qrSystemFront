            ...
            {user ? (
                user.length ? (
                    ...
                    <Form.Group as={Row} controlId="idQuery">
                        <Col xs={2}>
                            <Button variant='secondary' type='submit' className="green-color">
                                <span >
                        ...
                        <Col xs={10}>
                            <Form.Control type="text" placeholder="ID search" onChange={handleSearch} />
                        </Col>
                    </Form.Group>
                </Form>
                    ...
                    <tbody>
                            ...
                            {user.length ? (user.map(u => {
                                return (
                                    ...
                                    <tr as={Link} to={'/profile/'+ u._id} key={u._id} onClick={() => handleClick(u._id)} style={{ cursor: 'pointer' }}>
                                        
                                            <td>1416795</td>
                                            <td>12-06-2020</td>
                                            <td>{(u.firstName +' '+ u.middleName+' '+ u.lastName).toUpperCase()}</td>
                                            <td>09385576541</td>
                                        </tr>
                                )
