        ...
        <Col lg={8}>
            ...
            <div className="personal-info-form-group">
                ...
                <Form onSubmit={handleSubmit}>
                    <Form.Group as={Row} controlId="firstName">
                        ...
                        <Col sm="1"></Col>
                        <Col sm="9">
                            <Form.Control className="reg-form" type="text" placeholder="John" onChange={handleChange}/>
                        </Col>
                    </Form.Group>
                    ...
                    <Form.Group as={Row} controlId="middleName">
                        ...
                        <Col sm="9">
                            <Form.Control type="text" className="reg-form" placeholder="Doe" onChange={handleChange}/>
                        </Col>
                    </Form.Group>
                    ...
                    <Form.Group as={Row} controlId="lastName">
                        ...
                        <Col sm="9">
                            <Form.Control type="text" className="reg-form" placeholder="Smith" onChange={handleChange}/>
                        </Col>
                    </Form.Group>
                    <hr/>
                    <Form.Group as={Row} controlId="birthDate">
                        ...
                        <Col sm="9">
                            <Form.Control type="date" className="reg-form" onChange={handleChange}/>
                        </Col>
                    </Form.Group>
                    <hr />
                    <Form.Group as={Row} controlId="contactNo">
                        ...
                        <Col sm="9">
                            <Form.Control type="text" className="reg-form" onChange={handleChange}/>
                        </Col>
                    </Form.Group>
                    <hr />
                    <Form.Group as={Row} controlId="classification" onChange={handleChange}>
                        <Form.Label column sm="3">Classification: </Form.Label>
                        <Col sm="9">
                            <Form.Check
                                type="radio"
                    ...
                    <Form.Group as={Row}>
                        ...
                        <Col sm="3">
                            <Form.Group controlId="phase">
                                <Form.Control type="text" className="reg-form" placeholder="Phase"  onChange={ handleAddress}/>
                            </Form.Group>
                        </Col>
                        <Col sm="3">
                            <Form.Group controlId="streetNo">
                                <Form.Control type="text" className="reg-form" placeholder="Street No." onChange={handleAddress} />
                            </Form.Group>
                        </Col>
                        <Col sm="3">
                            <Form.Group controlId="houseNo">
                                <Form.Control type="text" className="reg-form" placeholder="House No."  onChange={handleAddress} />
                            </Form.Group>
                        </Col>
                    </Form.Group>
                    ...
                    <Form.Group as={Row} controlId="subdivision">
                        ...
                        <Col sm="1"></Col>
                        <Col sm="9">
                            <Form.Control as="select" placeholder="subdivision" onChange={handleAddress}>
            ...
            <Col lg={4}>
                <div id="user-image-div">
                     <div>
                        <Image src={uImage} id="user-image" thumbnail fluid style={{ width: '228px', height: '221px' }} />
